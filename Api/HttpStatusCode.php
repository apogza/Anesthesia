		...
		public static function getMessage($statusCode)
		{
			switch ($statusCode)
			{
				case HttpStatusCode::CREATED:
					return array("message" => "Item created");
				case HttpStatusCode::ACCEPTED:
					return array("message" => "Request accepted");
				case HttpStatusCode::NO_CONTENT:
					return array("message" => "No content");
				case HttpStatusCode::UNAUTHORIZED:
					return array("message" => "Not Authorized");
				case HttpStatusCode::NOT_FOUND:
					return array("message" => "Resource not found");
				case HttpStatusCode::NOT_ACCEPTABLE:
					return array("message" => "Content not acceptable");
